...
const navItems = [
  ...
  { href: "/patient/wallet", icon: WalletCards, label: "Wallet" },
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <Link href="/patient" className="flex items-center gap-3">
              <CaseHospitalLogo width={88} height={56} />
              <div>
                <p className="text-lg font-semibold leading-none">Case Hospital</p>
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "bg-primary text-primary-foreground shadow-[0_10px_22px_rgba(0,128,96,0.18)]"
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="hidden items-center gap-3 rounded-full border border-border/70 bg-card/70 px-2.5 py-2 sm:flex">
              ...
              <div className="pr-2">
                ...
                <p className="mt-1 text-xs uppercase tracking-[0.16em] text-muted-foreground">CASE-1029-4476</p>
              </div>
            ...
            <Link href="/patient/settings" className="sm:hidden">
